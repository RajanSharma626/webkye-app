                        ...
                        <table class="table align-middle" id="caseStudiesTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.case-studies.edit', $caseStudy->id) }}" class="btn btn-sm btn-primary">Edit</a>
                                        <form action="{{ route('admin.case-studies.destroy', $caseStudy->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            @method('DELETE')
