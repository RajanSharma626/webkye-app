...
@section('title', 'About Us | Webkye')
@section('description',
    'About Webkye | We are a team of web developers who are dedicated to building websites that are
    fast, secure, and easy to use.')
@section('keywords',
    'about us, webkye, web development, web development services, custom website development, website
                ...
                <div class="row g-4 justify-content-between">
                    <div class="col-lg-5">
                        <div class="fanfact__item-left">
                            ...
                            <p class="mb-40">We build custom websites, web apps, and digital solutions that bring your
                                vision to life.</p>
                            <h2>Our Mission </h2>
                            <p class="mb-30">To help startups, businesses, and creators launch powerful digital experiences
                                with the right strategy and technology.</p>
                            <h2>Our Vision</h2>
                            <p>To be a trusted web development partner that simplifies technology and helps businesses grow
                                online.</p>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h2 class="mb-60 ">Trusted by Startups, Loved by Businesses</h2>
                        <div class="fanfact__item-right">
                            <div class="fanfact__item mb-60">
                                <h2 class="mb-10"><span class="count">50</span>+</h2>
                                <strong>Completed Projects</strong>
                            </div>
                            <div class="fanfact__item">
                                <h2 class="mb-10"><span class="count">98</span>%</h2>
                                <strong>Satisfied Clients</strong>
                            </div>
                            <div class="fanfact__item">
                                <h2 class="mb-10"><span class="count">20</span>%</h2>
        ...
        <section class="testimonial-four-area pt-120 pb-120">
            <div class="container">
                <div class="d-flex flex-wrap mb-80 justify-content-between align-items-end gap-3">
                    ...
                    <p>
                        A satisfied client is the true measure of successful collaboration <br>and a thoughtful approach to
                        every project.
                    <p>
                </div>
                <div class="testimonial-four__info mb-80">
                    <div class="testi-conter-wrp">
                        <div class="testi-conter">
                            ...
                            <span class="fs-18">verified reviews on Fiverr</span>
                        </div>
                        <div class="line"></div>
                        <div class="testi-conter">
                            <h3><span class="count">5.0</span>+</h3>
                            <span class="fs-18">Average rating on Fiverr</span>
                        </div>
                    </div>
